...
test('isHiddenSearchMode rejects public recent mode', () => {
  assert.equal(isHiddenSearchMode('recent'), false)
})
...
test('hiddenSearchModeExitTarget restores previous recent mode', () => {
  assert.equal(hiddenSearchModeExitTarget('recent'), 'recent')
})
...
test('hiddenSearchModeExitTarget defaults hidden favorites mode to recent', () => {
  assert.equal(hiddenSearchModeExitTarget('favorites'), 'recent')
})

test('hiddenSearchModeExitTarget defaults null to recent', () => {
  assert.equal(hiddenSearchModeExitTarget(null), 'recent')
})
