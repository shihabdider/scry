...
Before uploading a new package, run the checks and build the store zip:
...
Upload `dist/scry-0.1.1.zip` as the extension package. The Chrome Web Store listing screenshot is `store-assets/screenshot-1280x800.png`.
